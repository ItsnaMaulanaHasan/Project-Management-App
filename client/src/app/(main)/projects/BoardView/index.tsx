  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`/${task.attachments[0].fileURL || "logo.png"}`}
      ...
      <div className="p-4 md:p-6">
        <div className="flex items-start justify-between">
          ...
          >
            <MenuHandler>
              <button className="flex h-6 w-4 flex-shrink-0 items-center justify-center hover:bg-gray-100 dark:text-neutral-500">
                <EllipsisVertical size={26} />
              </button>
            </MenuHandler>
            <MenuList
              className="space-y-2 border-none p-2 shadow-lg"
              dismissible
              placeholder=""
            >
              <MenuItem
                onClick={() => setIsEditModalOpen(true)}
                className="rounded px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                placeholder=""
              >
                Edit
              </MenuItem>
              <MenuItem
                ...
                className="rounded px-4 py-2 text-left text-sm text-red-500 hover:bg-gray-100 dark:hover:bg-gray-700"
                placeholder=""
              >
                Hapus
              </MenuItem>
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`/${task.assignee.profilePictureUrl! || "logo.png"}`}
            ...
            {task.author && (
              <Image
                ...
                src={`/${task.author.profilePictureUrl! || "logo.png"}`}
